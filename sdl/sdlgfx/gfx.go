...
func Circle(re *sdl.Renderer, x, y, rad int, c sdl.Color) error {
	return ek(C.circleRGBA((*C.SDL_Renderer)(re), C.Sint16(x), C.Sint16(y), C.Sint16(rad), C.Uint8(c.R), C.Uint8(c.G), C.Uint8(c.B), C.Uint8(c.A)))
}
...
func FilledCircle(re *sdl.Renderer, x, y, rad int, c sdl.Color) error {
	return ek(C.filledCircleRGBA((*C.SDL_Renderer)(re), C.Sint16(x), C.Sint16(y), C.Sint16(rad), C.Uint8(c.R), C.Uint8(c.G), C.Uint8(c.B), C.Uint8(c.A)))
}
