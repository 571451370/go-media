...
func (c *EncoderRequest) SetRep() {
	C.xed_encoder_request_set_rep((*C.xed_encoder_request_t)(c))
}

func (c *EncoderRequest) SetRepne() {
	C.xed_encoder_request_set_repne((*C.xed_encoder_request_t)(c))
}
